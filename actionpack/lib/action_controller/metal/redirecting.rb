  ...
  module Redirecting
    ...
    private
      ...
      def _url_host_allowed?(url)
        ...
        return true if _allowed_redirect_hosts_persmissions.allows?(host)
      ...
      def _allowed_redirect_hosts_persmissions
        @allowed_redirect_hosts_persmissions ||= ActionDispatch::HostAuthorization::Permissions.new(allowed_redirect_hosts)
      end
  end
end
